...
const char *perror_message(void)
{
	switch (pvars_errno) {
		...
		case FAILURE_PDICT_ADD_STR_KEY_EXISTS:
			return "FAILURE: Key already exists in function pdict_add_str()";
		...
		case FAILURE_PDICT_SET_STR_NULL_INPUT_DICT:
			return "FAILURE: NULL dict input passed to function pdict_set_str()";
		case FAILURE_PDICT_SET_STR_NULL_INPUT_KEY:
			return "FAILURE: NULL key input passed to function pdict_set_str()";
		case FAILURE_PDICT_SET_STR_NULL_INPUT_VALUE:
			return "FAILURE: NULL value input passed to function pdict_set_str()";
		case FAILURE_PDICT_SET_STR_VALUE_STRDUP_FAILED:
			return "FAILURE: strdup() failed to allocate memory to new_string in function pdict_set_str()";
		...
		case FAILURE_PDICT_ADD_INT_KEY_EXISTS:
			return "FAILURE: Key already exists in function pdict_add_int()";
		...
		case FAILURE_PDICT_ADD_DOUBLE_KEY_EXISTS:
			return "FAILURE: Key already exists in function pdict_add_double()";
		...
		case FAILURE_PDICT_ADD_LONG_KEY_EXISTS:
			return "FAILURE: Key already exists in function pdict_add_long()";
		...
		case FAILURE_PDICT_ADD_FLOAT_KEY_EXISTS:
			return "FAILURE: Key already exists in function pdict_add_float()";
		...
		case FAILURE_PDICT_ADD_LIST_KEY_EXISTS:
			return "FAILURE: Key already exists in function pdict_add_list()";
		...
		case FAILURE_PDICT_ADD_DICT_KEY_EXISTS:
			return "FAILURE: Key already exists in function pdict_add_dict()";
